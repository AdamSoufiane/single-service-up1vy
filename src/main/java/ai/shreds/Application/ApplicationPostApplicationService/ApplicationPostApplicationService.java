...
import ai.shreds.shared.ApplicationInternalServerException;
...
public class ApplicationPostApplicationService {
    ...
    public ApplicationPostListDTO getPosts(SharedRequestParams params) {
        try {
            ...
            throw new ApplicationInternalServerException("Internal server error during post retrieval", "Error occurred while retrieving posts.");
        }
    }
    ...
    public SharedPostDTO getPostById(Long id) {
        try {
            ...
            throw new ApplicationInternalServerException("Internal server error during post retrieval by ID", "Error occurred while retrieving post by ID.");
        }
    }
    ...
    public SharedPostDTO getPostBySlug(String slug) {
        try {
            ...
            throw new ApplicationInternalServerException("Internal server error during post retrieval by slug", "Error occurred while retrieving post by slug.");
        }
    }
